...
#         elif traversal_type == "i_size":
#             return self.i_sizeOfTree()
#         elif traversal_type == "r_size":
#             return self.r_sizeOfTree(tree.root)
#         else:
...
# print(tree.print_tree("i_size"))
# print(tree.print_tree("r_size"))
